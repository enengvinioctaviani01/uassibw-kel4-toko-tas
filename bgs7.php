			...
			<div class="header-right">
				<div class="search">
					...
					<div class="head-signin">
						<h5><a href="login.php
						"><i class="hd-dign"></i>Sign in</a></h5>
					</div>              
   	 ...
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
				    <li data-thumb="images/bgs6.jpg">
				        <div class="thumb-image"> <img src="images/bgs6.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
			...
			<div class="col-md-7 single-top-left simpleCart_shelfItem">
				...
				<ul class="bann-btns">
					...
					" class="item_add">Add To Cart</a></li>					
	            </ul>
			</div>
		   <div class="clearfix"> </div>
	   </div>
		   	 ...
		   	 <div class="col-md-3 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
						  <a href="bags6.php "><img src="images/bgs6.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
