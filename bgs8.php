   	 ...
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
				    <li data-thumb="images/bgs8.jpg">
				        <div class="thumb-image"> <img src="images/bgs8.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
		   	 ...
		   	 <div class="col-md-3 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
                          <a href="bags8.php"><img src="images/bgs8.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="bags8.php">Smart Shopping</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
						</div>
