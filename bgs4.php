   	 ...
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
				    <li data-thumb="images/bgs4.jpg">
				        <div class="thumb-image"> <img src="images/bgs4.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
		   	 ...
		   	 <div class="col-md-3 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
						  <a href="bags4.php
						  "><img src="images/bgs4.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
