   	 ...
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
				    <li data-thumb="images/bgs5.jpg">
				        <div class="thumb-image"> <img src="images/bgs5.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
		   	 ...
		   	 <div class="col-md-3 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
						  <a href="bags5.php
						  "><img src="images/bgs5.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
