	              ...
	              <nav class="navbar navbar-default" role="navigation">
					 ...
					 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					        <ul class="nav navbar-nav">
						        ...
						        <li><a href="bags/contact.php">Contact</a></li>
					        </ul>
					    </div>
					    <!--/.navbar-collapse-->
					</nav>
	...
	<div class="container">
		<div class="banner-main">
			<div class="col-md-6 banner-left">
				<a href="single.php"><img src="images/ba.png" alt="" class="img-responsive"></a>
			</div>
			<div class="col-md-6 banner-right simpleCart_shelfItem">
				...
				<ul class="bann-small-img">
					<li><a href="single.php"><img src="images/b1.jpg"></a></li>
					<li><a href="single.php"><img src="images/b2.jpg"></a></li>
				</ul>
				<h6>Size Charts</h6>
				<ul class="bann-btns">
				...
				<li><a href="checkout.php" class="item_add">Add To Cart</a></li>
               </ul>
			</div>
			<div class="clearfix"> </div>
		</div>
	...
	<div class="container">
		<div class="blc-layer3-main">
			   ...
			   <div class="col-md-4 blc-layer3-grids2">
			   	<a href="single.php"><img src="images/bracelate.png" alt=""></a>
			   </div>
			   <div class="col-md-4 blc-layer3-grids-3 simpleCart_shelfItem">
				 <div class="box-grid">
				   	<h3><a href="single.php">Brand</a></h3>
				   	<p>Nam libero tempore cum</p>
				   	<h5>At vero eos et accusamus iusto</h5>
				   	<a href="single.php"><img src="images/w2.png" alt=""></a>
	...
	<div class="container">
		<div class="home-block-main">
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.php"><img src="images/h1.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.php"><img src="images/h2.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.php">Smart Shopping</a></h3>
							<p>Explore Now</p>						
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.php"><img src="images/h3.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.php">Smart Shopping</a></h3>
							<p>Explore Now</p>						
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.php"><img src="images/h4.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.php">Smart Shopping</a></h3>
							<p>Explore Now</p>						
