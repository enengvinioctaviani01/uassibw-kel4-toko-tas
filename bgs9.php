   	 ...
   	 <div class="single-main">
   	 	<div class="single-top-main">
			   ...
			   <div class="flexslider">
				  <ul class="slides">
				    <li data-thumb="images/bgs9.jpg">
				        <div class="thumb-image"> <img src="images/bgs9.jpg" data-imagezoom="true" class="img-responsive"> </div>
				    </li>
			...
			<div class="col-md-7 single-top-left simpleCart_shelfItem">
				...
				<h6 class="item_price">Rp.50.000</h6>			
		   	 ...
		   	 <div class="col-md-3 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
                          <a href="bags9.php"><img src="images/bgs9.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="bags9.php">Smart Shopping</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
						</div>
		...
		<div class="footer-main">
			<div class="ftr-grids-block">
				...
				<div class="col-md-3 footer-grid-icon">
					<ul>
                        <li><a href="https://www.instagram.com/lavira_co/"><span class="instro"> </span></a></li>
					</ul>
					<form>
