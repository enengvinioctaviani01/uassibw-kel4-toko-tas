...
<php>
<head>
<title>Shoplist A Ecommerce Category Flat Bootstrap Responsive  Website Template | Pressroom :: w3layouts</title>
...
<div class="press">
	<div class="container">
		<div class="press-main">
			<div class="press-top">
				   <div class="col-md-8 press-left">
				   	 <h1>Latest Press Releases</h1>
				   	  <div class="press-grid">
				   	  	  <div class="col-md-6 press-imgs">
				   	  	  	 <img  src="images/p1.jpg" alt="" class="img-responsive">
				   	  	  </div>
				   	  	  <div class="col-md-6 press-text">
